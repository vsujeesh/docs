...
- Ideas of user: learn-anything.org/user/<username> (`learn-anything.org/user/nikita`)
- Idea of user: learn-anything.org/user/<username>/<idea-id> (`learn-anything.org/user/nikita/15`)
